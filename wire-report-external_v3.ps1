...
# --- 1) Ensure Build Report button exists near bottom (non-destructive append) ---
...
# --- 3) Inject <script src="wh-report.js"> include (non-destructive) ---
if ($updated -match '(?is)wh-report\.js') {
